...
These classes are defined in src/datasets/segmentation.
...
4. To run scripts, make sure --dataset_root is set to (absolute path of) my_CocoStuff164k_directory, and --fine_to_coarse_dict is set to (absolute path of) src/datasets/segmentation/util/out/fine_to_coarse_dict.pickle
...
2. Decompress the downloaded file, and run the script src/datasets/segmentation/util/potsdam_prepare.py with SOURCE_IMGS_DIR, SOURCE_GT_DIR, OUT_DIR changed as necessary.
