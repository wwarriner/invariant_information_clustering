...
from src.utils.cluster.eval_metrics import _hungarian_match, _original_match, _acc
from src.utils.segmentation.data import make_Coco_dataloaders, make_Potsdam_dataloaders
...
def _get_vectorised_sift_samples(archetype_config, dataloader):
    ...
    central_inds_h, central_inds_w = (
        central_inds_h.reshape(-1),
...
def main():
    ...
    # -------------------------------------------------------------------------
    if "Coco" in archetype_config.dataset:
        dataloaders_head_A, mapping_assignment_dataloader, mapping_test_dataloader = make_Coco_dataloaders(
            archetype_config
        )

    elif archetype_config.dataset == "Potsdam":
        dataloaders_head_A, mapping_assignment_dataloader, mapping_test_dataloader = make_Potsdam_dataloaders(
            archetype_config
        )
    else:
